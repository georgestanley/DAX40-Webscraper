...
--
-- Host: localhost    Database: insider_trades
-- ------------------------------------------------------
...
--
-- Table structure for table `script_executions`
--
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trades` (
  `tranx_id` int NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2022-01-02  0:17:57
